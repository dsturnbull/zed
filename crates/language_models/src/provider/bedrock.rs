...
mod tests {
    use super::*;
    use language_model::{CompletionIntent, LanguageModelRequestMessage, MessageContent};
    ...
    fn test_au_region_model_id_without_global() {
        // Verifies the model ID used when region=ap-southeast-2,
        // allow_global=false — the user's actual configuration.
        let model_id = bedrock::Model::ClaudeOpus4_6
